...
<div class="auth-card">
    <div class="auth-header">
        <h3>Welcome Back</h3>
        <p class="mb-0 text-white-50">Sign in to your News Portal account</p>
    </div>
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <div class="mb-4">
                <div class="d-flex justify-content-between align-items-center mb-1">
                    ...
                    <a href="{{ route('password.request') }}" class="small text-secondary">Forgot Password?</a>
                </div>
                <div class="input-group">
                    <span class="input-group-text bg-light border-end-0 text-secondary"><i class="fa-solid fa-lock"></i></span>
                    <input type="password" class="form-control border-start-0 @error('password') is-invalid @enderror" id="password" name="password" placeholder="Enter password" required>
                    @error('password')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
    ...
    <div class="auth-footer">
        <p class="text-secondary small mb-0">Don't have an account? <a href="{{ route('register') }}">Sign Up</a></p>
    </div>
</div>
