...
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-secondary mb-0">Create a new reporter, journalist, or staff writer profile.</p>
        </div>
        ...
        <div class="card-body p-5">
            <form action="{{ route('admin.authors.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-8">
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control py-3" id="username" name="username" value="{{ old('username') }}" placeholder="e.g. john_doe" required>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control py-3" id="phone" name="phone" value="{{ old('phone') }}" placeholder="e.g. +88017XXXXXXXX">
                            </div>
                        </div>

                        <div class="mb-4">
                            <label for="designation" class="form-label fw-semibold text-secondary">Designation</label>
                            <input type="text" class="form-control py-3" id="designation" name="designation" value="{{ old('designation') }}" placeholder="e.g. Senior Investigative Reporter">
                        </div>

                        <div class="mb-4">
                            <label for="bio" class="form-label fw-semibold text-secondary">Biography</label>
                            <textarea class="form-control" id="bio" name="bio" rows="5" placeholder="Enter short bio details...">{{ old('bio') }}</textarea>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="url" class="form-control py-3" id="facebook" name="facebook" value="{{ old('facebook') }}" placeholder="https://facebook.com/username">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="url" class="form-control py-3" id="twitter" name="twitter" value="{{ old('twitter') }}" placeholder="https://twitter.com/username">
                            </div>
                        </div>
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="url" class="form-control py-3" id="instagram" name="instagram" value="{{ old('instagram') }}" placeholder="https://instagram.com/username">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="url" class="form-control py-3" id="linkedin" name="linkedin" value="{{ old('linkedin') }}" placeholder="https://linkedin.com/in/username">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card bg-light bg-opacity-25 border-0 p-4 rounded-3 mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="file" class="form-control" id="profile_photo_upload" name="profile_photo_upload">
                            </div>
                ...
                <div class="border-top border-light mt-5 pt-4 text-end">
                    <button type="submit" class="btn btn-primary px-5 py-3 rounded-pill fw-semibold shadow-sm"><i class="fa-solid fa-circle-check me-2"></i> Save Author Profile</button>
                </div>
            </form>
        </div>
    </div>
