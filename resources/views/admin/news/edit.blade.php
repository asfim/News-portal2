                        ...
                        <div class="border-top pt-4">
                            ...
                            <div class="form-check form-switch ps-0 mb-3">
                                <label class="form-check-label fw-semibold text-dark small" for="breaking_news">Breaking
                                    News Alert</label>
                                @php
                                  $breakingCount = \App\Models\News::where('breaking_news', true)->where('id', '!=', $news->id)->count();
                                @endphp
                                <input class="form-check-input ms-0 border-secondary-subtle float-end"
                                    ...
                                    {{ ($breakingCount >= 11 && !$news->breaking_news) ? 'disabled' : '' }}
                                    {{ old('breaking_news', $news->breaking_news) ? 'checked' : '' }}>
                                @if($breakingCount >= 11 && !$news->breaking_news)
                            ...
                            <div class="form-check form-switch ps-0 mb-3">
                                <label class="form-check-label fw-bold text-danger small" for="is_latest">Latest News (Max
                                    9)</label>
                                @php
                                  $latestCount = \App\Models\News::where('is_latest', true)->where('id', '!=', $news->id)->count();
                                @endphp
                                <input class="form-check-input ms-0 border-danger float-end"
                                    ...
                                    value="1"
                                    {{ ($latestCount >= 9 && !$news->is_latest) ? 'disabled' : '' }}
                                    {{ old('is_latest', $news->is_latest) ? 'checked' : '' }}>
                                @if($latestCount >= 9 && !$news->is_latest)
                            ...
                            <div class="form-check form-switch ps-0 mb-3">
                                ...
                                <input class="form-check-input ms-0 float-end"
                                    ...
                                    value="1"
                                    {{ old('is_gallery', $news->is_gallery) ? 'checked' : '' }}>
                            </div>
                        </div>
                    </div>
