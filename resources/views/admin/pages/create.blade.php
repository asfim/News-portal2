...
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold text-dark mb-1">Add Static Page</h2>
            <p class="text-secondary mb-0">Compose a new static page with content and metadata settings.</p>
        </div>
    ...
    <form action="{{ route('admin.pages.store') }}" method="POST">
        ...
        <div class="row g-4">
                    ...
                    <div class="tab-pane fade" id="seoSec" role="tabpanel" aria-labelledby="seo-tab">
                        <div class="card border-0 shadow-sm rounded-3 p-4 mb-4">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control py-3" id="meta_title" name="meta_title" value="{{ old('meta_title') }}" placeholder="Leave blank to use page title">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control py-3" id="meta_keywords" name="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="e.g. privacy, policy, portal">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="text-end">
                    <button type="submit" class="btn btn-primary w-100 py-3 rounded-pill fw-semibold shadow-sm"><i class="fa-solid fa-circle-check me-2"></i> Save Page</button>
                </div>
            </div>
        </div>
    </form>
